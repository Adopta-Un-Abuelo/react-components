...
const TextAreaView = styled.textarea<{ $design?: "design-1" | "design-2" }>`
	...
	box-shadow: 0 0 0
		${(props) =>
			props.$design === "design-2" ? "1px " + Color.line.soft : "none"};
	...
	background-color: ${(props) =>
		props.$design === "design-2" ? "white" : Color.background.soft};
	&:placeholder-shown {
		&:focus {
			box-shadow: 0 0 0
				${(props) =>
	...
	return props.type === "edit" ? (
		<Container role="text-area" style={props.style}>
			<Editor
				...
				wrapperClassName={
					props.design === "design-1" ? "wrapper" : "wrapper"
				}
				editorClassName={
					props.design === "design-1" ? "editor" : "editorV2"
				}
				toolbarClassName={
					props.design === "design-1" ? "toolbar" : "toolbarV2"
				}
			/>
		</Container>
	) : (
