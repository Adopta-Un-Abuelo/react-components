...
export const All = (args: any) => {
	return (
		<div>
			<Text type="d1" weight="semibold">
				Display d1 semibold
			</Text>
			<Text type="d1" weight="medium">
				Display d1 medium
			</Text>
			<Text type="d1" weight="regular">
				Display d1 regular
			</Text>
			...
			<Text type="p2" weight="regular">
				Paragraph p2 regular
			</Text>
			<Text type="c1" weight="semibold">
				Caption c1 semibold
			</Text>
			...
			<Text type="c2" weight="semibold">
				Caption c2 semibold
			</Text>
			<Text type="c2" weight="medium">
				Caption c2 medium
			</Text>
			<Text type="c2" weight="regular">
				Caption c2 regular
			</Text>
			<Text type="o1" weight="semibold">
				Caption o1 semibold
			</Text>
			<Text type="o1" weight="medium">
				Caption o1 medium
			</Text>
			<Text type="o1" weight="regular">
				Caption o1 regular
			</Text>
			<Text type="o2" weight="semibold">
				Caption o2 semibold
			</Text>
			<Text type="o2" weight="medium">
				Caption o2 medium
			</Text>
			<Text type="o2" weight="regular">
				Caption o2 regular
			</Text>
			...
			<Text type="b2" weight="regular">
				Button b2 regular
			</Text>
			<Text type="b3" weight="semibold">
				Button b3 semibold
			</Text>
			<Text type="b3" weight="medium">
				Button b3 medium
			</Text>
			<Text type="b3" weight="regular">
				Button b3 regular
			</Text>
		</div>
	);
